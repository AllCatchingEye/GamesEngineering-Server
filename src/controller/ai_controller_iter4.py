...
class AiController_4It(PlayerController):
    def __init__(self, train: bool = False):
        ...
        self.play_game_agent = DQLAgent(ModelIter02(layers=[256, 256, 256, 256, 256, 256, 256, 256], custom_prefix="v_04"))
