...
from ai.select_card.drl_agent_trainer import LR, DRLAgentTrainer
...
async def run_arena(
    get_ai_controller: Callable[[list[int], bool], PlayerController],
    game_type: Gametype,
    layers: Sequence[int],
    epoch: int,
    prefix: str,
    ...
    def get_ai_ctrl() -> PlayerController:
        return get_ai_controller(list(layers), False)
